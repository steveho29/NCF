...
def evaluation_log_hook(
    ...
    **eval_kwargs
    ...
    .. note::
       TensorFlow Estimator model uses the last checkpoint weights for calculate_metrics or prediction.
       In order to get the most up-to-date calculate_metrics results while training,
    ...
    Args:
        ...
        batch_size (int): Number of samples fed into the model at a time.
            Note, the batch size doesn't affect on calculate_metrics results.
        eval_fns (iterable of functions): List of calculate_metrics functions that have signature of
